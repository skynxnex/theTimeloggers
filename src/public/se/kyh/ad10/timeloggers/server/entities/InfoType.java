...
public class InfoType {
    ...
    * <pre>
    *           0..*     0..*
    * InfoType ------------------------- InfoTypeDAOImpl
    *           infoType        &lt;       infoTypeDAO
    * </pre>
    */
   private Set<InfoTypeDAOImpl> infoTypeDAO;
   
   public Set<InfoTypeDAOImpl> getInfoTypeDAO() {
      if (this.infoTypeDAO == null) {
         this.infoTypeDAO = new HashSet<InfoTypeDAOImpl>();
      }
      return this.infoTypeDAO;
   }
